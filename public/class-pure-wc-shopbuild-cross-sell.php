...
class Pure_Wc_Shopbuild_Cross_Sell {
    ...
    public function add_to_cart_fragments( $fragments ) {
        ...
        if(isset($_SESSION['recently_added_product_id'])){
            ...
            pure_wc_product_info_for_crosssell_notification((int) $_SESSION['recently_added_product_id']);
            if(!empty($product)){
    ...
    public function footer(){
        ?>
            <div class="pure-wc-cart-crosssell-notification-box-wrapper"></div>
        <?php
    }
}
Pure_Wc_Shopbuild_Cross_Sell::get_instance();
