...
;(function($, window, document, undefined){
    'use strict';
      ...
      $.fn.jQueryTab.defaults = {
        ...
        //classes settings
        tabClass:'pure-wc-tabs',				    // class of the tabs
        accordionClass:'accordion_tabs',	// class of the header of accordion on smaller screens
        contentWrapperClass:'pure-wc-tab-content-wrapper',		// class of content wrapper
        contentClass:'pure-wc-tab-content-single',		// class of container
